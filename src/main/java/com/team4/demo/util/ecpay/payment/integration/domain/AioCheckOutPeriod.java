package com.team4.demo.util.ecpay.payment.integration.domain;
...
//	}
	...
	public String toString() {
		return "AioCheckOutPeriod [MerchantID=" + MerchantID + ", MerchantTradeNo=" + MerchantTradeNo
				...
				+ IgnorePayment + ", PlatformID=" + PlatformID + ", InvoiceMark=" + InvoiceMark + ", EncryptType=" + EncryptType + ", PeriodAmount=" + PeriodAmount + ", PeriodType="
				+ PeriodType + ", Frequency=" + Frequency + ", ExecTimes=" + ExecTimes + ", PeriodReturnURL="
				+ PeriodReturnURL + ", Language=" + Language + ", StoreID=" + StoreID + ", CustomField1=" + CustomField1
