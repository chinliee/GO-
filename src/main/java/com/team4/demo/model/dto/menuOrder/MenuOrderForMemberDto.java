...
@NoArgsConstructor
@Builder
public class MenuOrderForMemberDto {
    ...
    private String restaurantPhotoSrc;
    ...
    public void setRestaurantPhoto(byte[] photo) {
        ...
        this.restaurantPhoto = photo;

        if (photo == null) {
            this.restaurantPhotoSrc = null;
            return;
        }
        ...
        try {
            ...
            this.restaurantPhotoSrc = photoBase64;
